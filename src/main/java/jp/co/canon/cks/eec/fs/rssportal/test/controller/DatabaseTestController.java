...
public class DatabaseTestController {
    ...
    public String addPlan() {
        ...
        serviceCollectionPlan.addPlan("planid", tools1, tools1, logTypes1, logTypes1, start1, start1, end1, "cycle",
        ...
        serviceCollectionPlan.addPlan("planid", tools2, tools2, logTypes2, logTypes2, start2, start2, end2, "cycle",
